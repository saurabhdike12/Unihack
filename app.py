...
st.set_page_config(
    page_title="UniLog | AI Product Intelligence Engine",
    page_icon="⚡",
    layout="wide",
...
def format_sku_to_unilog_delivery(product_dict: dict) -> pd.DataFrame:
...
<div class="hero-container">
    <div class="hero-title">⚡ UniLog AI Product Intelligence Engine</div>
    ...
    with tab1:
        ...
        if attrs:
            ...
            with btn_col2:
                ...
                delivery_df = format_sku_to_unilog_delivery(product)
